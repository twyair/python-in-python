...
class PyCodec:
    ...
    def get_encode_func(self) -> PyObject:
        return self.value._.as_slice()[0]

    def get_decode_func(self) -> PyObject:
        return self.value._.as_slice()[1]
